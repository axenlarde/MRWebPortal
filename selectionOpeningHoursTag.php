...
try
	...
	for($i = 1; $i<20; $i++)
		{
		$TagName = "tag".$i;
		$OpeningHoursFileNameTag = $PTFile->$TagName->openinghours;
		if($OpeningHoursFileNameTag == null || ($OpeningHoursFileNameTag == ""))
			...
			echo"
			<tr>
				<td align=\"left\">- <a href=\"mainpage.php?page=adminOpeningHoursTag&tag=".$SavedTagName."\">".$SavedTagName."</a></td>
			</tr>
			";
			}
		}
	if($TagCount == 1)
		...
		header("Location: mainpage.php?page=adminOpeningHoursTag&tag=".$SavedTagName);
		}
	}
catch(Exception $exc)
	{
